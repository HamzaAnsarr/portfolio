  ...
  return (
    ...
    >
      <div className="flex justify-center lg:justify-between gap-8 lg:gap-0 items-center relative flex-wrap-reverse w-full">
        <div className="flex flex-col items-center lg:items-start max-w-[45rem] lg:max-w-[33rem]">
          <motion.h1
          ...
          >
            I'm a passionate front-end developer specialised in building
            exceptional web apps from Manchester, UK 📍
          </motion.p>
          <ButtonLink
